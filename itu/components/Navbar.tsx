...
export default function Navbar({
    ...
    return (
        <nav
            className={
                'fixed top-0 w-full bg-gradient-to-bl from-gray-800 backdrop-blur-xl text-white z-10 inline-flex justify-between'
            }
        >
            <div
                className={'items-start justify-between flex-nowrap ml-5 gap-4'}
            >
                <button
                    id="toggleSidebar"
                ...
                <Link
                    className={'text-orange-200 text-4xl font-semibold'}
                    href={'/'}
                >
                    WATERWISE
                </Link>
            ...
            <div className={'flex end-0 mx-2 px-10 py-2 gap-2 items-center'}>
                ...
                <span
                    className={
                        "text-white text-2xl font-semibold font-['Inter']"
                    }
                >
