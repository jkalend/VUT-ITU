...
export default function Navbar({
  ...
  return (
    <nav
      className={
        "fixed top-0 w-full mb-16 bg-gradient-to-bl from-gray-800 backdrop-blur-xl text-white z-10 inline-flex justify-between"
      }
    >
      <div className={"items-start justify-between flex-nowrap ml-5 gap-4"}>
        ...
        <Link className={"text-orange-200 text-4xl font-semibold"} href={"/"}>
          WATERWISE
        </Link>
      </div>
