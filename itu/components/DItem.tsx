...
export default function DItem({
    ...
    return (
        <div className="w-[363px] h-[322px] relative">
            ...
            >
                <Image
                    className="w-[345.29px] h-[215px] left-[8.85px] top-[9px] absolute rounded-lg"
                    alt={'plant photo'}
            ...
            <div className="w-[164.90px] left-[99.60px] top-[287px] absolute text-stone-400 text-center text-sm font-semibold]">
                {plant.days >= 0
                    ? plant.days == 1
                        ...
                        : `in ${plant.days} days`
                    : plant.days == -1
                      ? `${-plant.days} day overdue`
                      : `${-plant.days} days overdue`}
            </div>
            ...
            <button
                className={
                    'w-[326px] h-[47px] px-[25px] py-[9px] left-[17px] top-[232px] absolute border border-black justify-center items-center gap-2.5 inline-flex text-white font-bold rounded-lg ' +
                    style
                }
                onClick={() => {
                    setWhichPlant(plant)
